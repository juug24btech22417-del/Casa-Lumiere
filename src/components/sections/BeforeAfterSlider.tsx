    ...
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          />
          {/* Subtle darken so the white slider label reads on light photos */}
          <div className="absolute inset-0 bg-deep-forest/15 pointer-events-none" />

          {/* "After" label */}
          <div className="absolute top-5 right-5 px-4 py-2 bg-available/20 border border-available/30 rounded-full z-10">
          ...
          >
            ...
            {/* "Before" label */}
            <div className="absolute top-5 left-5 px-4 py-2 bg-deep-forest/85 border border-champagne rounded-full backdrop-blur-sm">
